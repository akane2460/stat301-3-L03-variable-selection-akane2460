...
# fit workflow/model ----
tic("SVM POLY: REC 1") # start clock

# tuning code in here
tune_svm_poly_rec1 <- svm_poly_wflow |> 
  tune_grid(
...
save(tune_svm_poly_rec1, tictoc_svm_poly_rec1, 
     file = here("results/tune_svm_poly_rec1.rda"))
